...
const res1=await request.get(`https://dev362368.service-now.com/api/now/table/change_request/${sys_ID}`,{
...
const res1=await request.patch(`https://dev362368.service-now.com/api/now/table/change_request/${sys_ID}`,{
...
const res1=await request.delete(`https://dev362368.service-now.com/api/now/table/change_request/${sys_ID}`,{
